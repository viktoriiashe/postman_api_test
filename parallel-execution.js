...
//var path = require('path'), // ensures that the path is consistent, regardless of where the script is run from
     ...
     */
    options = {
        collection: 'MAIN_FLOW.postman_collection.json', //collection to be run
        //folders: "Pre-requisites, Login, Patient Registration",
        environment: 'QA.postman_environment.json', //your environment
        globals: 'MyWorkspace.postman_globals.json', //global variables
...
// Runs the Postman collection with number equals to number of function mentioned in parallel.
async.parallel([
